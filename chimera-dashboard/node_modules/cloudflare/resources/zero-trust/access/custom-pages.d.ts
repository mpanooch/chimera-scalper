...
export declare class CustomPages extends APIResource {
     ...
     * ```
     */
    list(params: CustomPageListParams, options?: Core.RequestOptions): Core.PagePromise<CustomPageWithoutHTMLsV4PagePaginationArray, CustomPageWithoutHTML>;
    /**
...
export declare class CustomPageWithoutHTMLsV4PagePaginationArray extends V4PagePaginationArray<CustomPageWithoutHTML> {
}
