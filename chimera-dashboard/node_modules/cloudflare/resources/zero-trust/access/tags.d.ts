...
export declare class Tags extends APIResource {
     ...
     * ```
     */
    list(params: TagListParams, options?: Core.RequestOptions): Core.PagePromise<TagsV4PagePaginationArray, Tag>;
    /**
     * Delete a tag
     *
     * @example
...
export declare class TagsV4PagePaginationArray extends V4PagePaginationArray<Tag> {
}
/**
 * A tag
 */
...
export declare namespace Tags {
    export { type Tag as Tag, type TagDeleteResponse as TagDeleteResponse, TagsV4PagePaginationArray as TagsV4PagePaginationArray, type TagCreateParams as TagCreateParams, type TagUpdateParams as TagUpdateParams, type TagListParams as TagListParams, type TagDeleteParams as TagDeleteParams, type TagGetParams as TagGetParams, };
}
