...
export declare class ServiceTokens extends APIResource {
     ...
     * ```
     */
    list(params?: ServiceTokenListParams, options?: Core.RequestOptions): Core.PagePromise<ServiceTokensV4PagePaginationArray, ServiceToken>;
...
export declare class ServiceTokensV4PagePaginationArray extends V4PagePaginationArray<ServiceToken> {
}
